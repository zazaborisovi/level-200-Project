...
export default function UserForm({endpoint}){
  ...
  return (
    <div className='container flex items-center justify-center m-2'>
      <Card className='bg-custom-card border-0 flex items-center justify-center *:w-[90%] text-center pt-10 pb-10'>
        <CardHeader>
